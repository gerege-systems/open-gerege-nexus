...
-- ЭРХГҮЙ ГИШҮҮН.
--
-- Шууд нэгдсэн хүн `memberships`-д л орно, `membership_roles`-д орохгүй —
-- зөвшөөрөгдсөн хүсэлтийн хийдэг яг тэр зүйл (access/joinrequests.go). Өөрөөр
-- хэлбэл нээлттэй байгууллага хаалгаа онгойлгож байгаа болохоос эрхээ
-- тараагаагүй: шинэ гишүүн байгаа, гэхдээ юу ч хийж чадахгүй хүртэл нь
-- админ роль өгнө.
--
--
...
ALTER TABLE registry.tenants
    ADD COLUMN IF NOT EXISTS join_policy TEXT NOT NULL DEFAULT 'on_request';
