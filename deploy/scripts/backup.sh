...
#
# ЭДГЭЭРИЙГ `export`-ТОЙ БИЧ. Cron мөр нь `. /etc/default/nexus-backup &&
# nexus-backup.sh` хэлбэртэй бөгөөд sourcing нь `export`-гүй утгыг зөвхөн
# дуудагч бүрхүүлд үлдээдэг: скрипт нь тусдаа процесс тул тэднийг хоосон гэж
# уншина. Үр дүн нь чимээгүй — dump амжилттай, offsite алхам эрт буцаж,
# нөөц хостоос хэзээ ч гарахгүй. 2026-08-31-нд яг ингэж тохиолдсон бөгөөд
# зөвхөн `nexus_backup_offsite_ok` 0 болсноор мэдэгдсэн.
#
