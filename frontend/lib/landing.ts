...
export const LANDING_SECTIONS = [
  ...
  // ээлж ирэх газарт: энэ суулгац дээр ЮУ АЖИЛЛАЖ БАЙГААГ эхлээд нэрлэнэ.
  "services",
  // Каталог нь түүний дараа: ажиллаж байгаа зүйлсээ харсан хүнд «үүн дээр
  // юу нэмэгдэж болох вэ» гэдэг нь дараагийн асуулт болдог. Урьд нь энэ
  // хоёр эсрэг дарааллаар байсан бөгөөд каталог нь юуны тухай яриа болохыг
  // хараахан ойлгоогүй хүнд эхэлж тулгардаг байв.
  "applications",
  "platform",
  "trust",
  "capabilities",
  // Гурван картын мөр — Nexus → eID → OIDC. Тэр нь аргумент биш, дүгнэлт:
  // бүх зүйлийг уншсаны дараа нэг мөрөнд эргэн харуулна. Тиймээс footer-ийн
  // яг дээр, хамгийн сүүлд.
  "technology",
] as const;
