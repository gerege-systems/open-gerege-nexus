 ...
 * documentation, some have all five, and a card leading to a hostname that
 * does not resolve is worse than no card.
 */
export const SERVICE_IDS = ["admin", "dwh", "backups", "monitor", "docs"] as const;
 ...
 * never mentions it, and a typo in one address cannot take the other four
 * down with it.
 */
