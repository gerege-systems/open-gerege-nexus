...
| `prod:/host` | **хэн ч биш** — зөвхөн хүн | Хостын өөрийн нууцууд: `GRAFANA_ADMIN_PASSWORD`, `MONITORING_DB_PASSWORD`, `GRAFANA_OAUTH_CLIENT_{ID,SECRET}`, `MONITOR_ALERTMANAGER_{USER,PASSWORD}`, `MINIO_ROOT_{USER,PASSWORD}`, `BACKUP_S3_{KEY,SECRET}`, `BACKUP_AGE_RECIPIENT`, `TSM_PASSWORD` |
| GitHub secret | `deploy.yml` | `DEPLOY_SSH_KEY`, `DEPLOY_HOST`, `DEPLOY_USER` — хост руу хүрэх зам, санд хүрэхээс өмнө хэрэгтэй |

`/host` нь тусдаа хавтас байгаа нь санамсаргүй биш: Infisical-ийн алхам
`INFISICAL_SECRET_PATH` (анхдагч `/`) дээрхийг л татдаг, дэд хавтас руу ордоггүй.
Тиймээс тэдгээр нь CI-ийн орчинд хэзээ ч гарч ирэхгүй — гарах шалтгаан ч
байхгүй, учир нь тэднийг ашигладаг зүйл бүхэн хост дээр гараар суудаг.
...
тэдгээрийн нууц бүр [`prod:/host`](#юу-хаана-байна) дээр байдаг тул шинийг
