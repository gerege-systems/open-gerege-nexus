...
`open-gerege-nexus` төсөл нь **зөвхөн** энэ платформын CI-ийн нууцыг барина.
Гараар суудаг бүхний нууц нь `Archive` гэсэн ӨӨР төсөлд байна — тэр төслийг
ямар ч workflow уншдаггүй, тиймээс тэдгээр нь CI-ийн орчинд хэзээ ч гарч ирэх
боломжгүй. (Эхэндээ эдгээрийг энэ төслийн дэд хавтсууд болгосон; Infisical-ийн
алхам зөвхөн `INFISICAL_SECRET_PATH` дээрхийг татдаг тул тэр нь ч ажиллах
байсан, гэхдээ тусдаа төсөл нь эрхийн хувьд ч тусгаарладаг.)
