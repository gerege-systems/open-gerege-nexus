...
гэрээний сэргийлж байгаа зүйл болдог — native хүрээн дотор web-ийн нэвтрэх
дэлгэц зурагдана. Модууд нийлсэн тэр өдөр DS-ийн үүрэг дуусаж, шугамууд буцаж
нэг стек рүү орсон.
...
### Аль бүрхүүл юуг хэрэгжүүлсэн бэ (2026-09-05)

Дээрх хүснэгт нь гэрээний ДЭЭД хязгаарыг тайлбарладаг. Бодит байдал дөрвөн
бүрхүүлд ижил биш бөгөөд энэ ялгааг бичихгүй байх нь web талд буруу таамаг
төрүүлдэг — `window.GeregeShell` байхгүй үед `data-shell` ч тавигдахгүй тул
хуудас өөрийгөө хөтөч дээр байна гэж үзнэ.

| Бүрхүүл | `window.GeregeShell` | Origin/main-frame шалгалт | Тэмдэглэл |
| --- | --- | --- | --- |
| macOS | ✅ `ShellBridge` (`Features/Platform/PlatformView.swift`) | ✅ `isMainFrame` + `sameOrigin` | Гэрээг бүрэн хэрэгжүүлсэн цорын ганц бүрхүүл |
| Windows | ❌ | — | `PlatformPage.xaml.cs` нь WebView2-ийн `Source`-ыг л тавина |
| iOS | ❌ **зориуд** | — | `MobilePlatformPage.swift` тайлбарт: гурван клиент дээр ажлын муж ижилхэн ажиллахын тулд |
| Android | ❌ **зориуд** | `WorkAreaWebViewClient` нь гарал шалгаж, бусдыг гадагш гаргана | `PlatformScreen.kt`, ижил шалтгаан |

Гурван бүрхүүлд гүүр байхгүй нь дутуу ажил биш, **шийдвэр**: ажлын муж нь
гурвуулан дээр ижил зан төлөвтэй байхын тулд гэрээний бүтэн гүүрийг
НЭГЭН ЗЭРЭГ нэмнэ. Тиймээс web тал `window.GeregeShell`-ийг **байхгүй байж
болох** зүйл гэж үзэх ёстой — capability бүрд fallback байх шаардлага (§4)
энэ мөрийг л барьж байгаа юм.
