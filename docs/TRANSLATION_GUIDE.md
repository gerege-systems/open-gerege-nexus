...
(операторын урсгал, `platform` schema, host багц, бүтээгдэхүүн). Кодод хоёр нь
2026-08-27-нд засагдсан — `internal/operator`, `pkg/host`. Интерфэйст харин
эхнээсээ ганц утгатай байсан бөгөөд тэр хэвээр байх ёстой:

| MN | Юу заана | Юуг **заахгүй** | EN |
| --- | --- | --- | --- |
| **Платформ** | Gerege Nexus бүтээгдэхүүн, эсвэл нэг суурилуулалт бүхэлдээ | Операторын урсгал; `platform` schema | platform |
...
| **Бүртгэл** | Суурилуулалтын бүртгэлийн schema (`registry`) | Үе G, эсвэл огт үгүй |
