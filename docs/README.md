...
| [`adr/0006-a-person-owns-a-space.md`](adr/0006-a-person-owns-a-space.md) | MN | Хүн муж эзэмшинэ: `workspace`/`operator`/`registry` нэршил, гэр ба байгууллага, иргэний буулт (`operator` хэрэгжсэн; хувийн муж **санал**) |
...
| [`WORKSPACE_NAMING_PROPOSAL.md`](WORKSPACE_NAMING_PROPOSAL.md) | MN | Нэршлийн засвар, хувийн орон зай, эрэлтийн тал (100 нийлүүлэгч), иргэний `/me` буулт — үе A–G (**A, B хэрэгжсэн**) |
