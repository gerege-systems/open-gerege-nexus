...
| `DEPLOY_HOST` / `DEPLOY_USER` / `DEPLOY_PORT` | No | Por defecto `open.gerege.mn` / `deploy` / `22` |
| `PUBLIC_ORIGIN` | No | Por defecto `https://open.gerege.mn` |

> El dominio de producción es `open.gerege.mn`, que sustituyó a
